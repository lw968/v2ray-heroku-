...
[[ "$SYS_Bit" == '32' ]] && C_Bit='_linux_386.tar.gz'
[[ "$SYS_Bit" == '64' ]] && C_Bit='_linux_amd64.tar.gz'
...
mkdir /caddybin
cd /caddybin
wget --no-check-certificate -qO 'caddy.tar.gz' "https://github.com/mholt/caddy/releases/download/$C_VER/caddy_$C_VER$C_Bit"
